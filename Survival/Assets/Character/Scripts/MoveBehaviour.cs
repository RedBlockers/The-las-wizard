...
public class MoveBehaviour : GenericBehaviour
{
	...
	{
		// Get jump input.
		if (!jump && Input.GetButtonDown(jumpButton) && behaviourManager.IsCurrentBehaviour(this.behaviourCode) && !behaviourManager.IsOverriding() && PlayerStats.canJump)
		{
			jump = true;
		}
	}
	...
	{
		// Start a new jump.
		if (jump && !behaviourManager.GetAnim.GetBool(jumpBool) && behaviourManager.IsGrounded() && PlayerStats.canJump)
		{
	...
	void MovementManagement(float horizontal, float vertical)
	{
		...
		speed *= speedSeeker;
		if (behaviourManager.IsSprinting() && PlayerStats.canSprint)
		{
			speed = sprintSpeed;
		}
